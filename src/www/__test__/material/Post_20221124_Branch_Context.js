...
export class Post_20221124_Branch_Context {
  async beforeTest() {
    // Do your setup here
  ...
  async givenANewGameWithAStackOfNSNSAndNSCards(n1, s1, n2, s2, n3, s3) {
    ...
    // code: await this.givenANewGameWithAStackOfNSNSAndNSCards(1, "Build Idea", 1, "Villager", 2, "Branch")
  ...
  async thereShouldBeNStacksOfNSNSAndNSCards(expected, n2, s1, n3, s2, n4, s3) {
    ...
    // code: await this.thereShouldBeNStacksOfNSNSAndNSCards(1, 1, "Build Idea", 1, "Villager", 1, "Wood")
