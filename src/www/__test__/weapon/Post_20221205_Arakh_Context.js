...
export class Post_20221205_Arakh_Context {
  async beforeTest() {
    // Do your setup here
    await waitForEnterTheGame();
  }

  async givenANewGameWithAStackOfNSNSNSNSNSAndNSCards(
    n1,
    s1,
    n2,
    s2,
    ...
    // code: await this.givenANewGameWithAStackOfNSNSNSNSNSAndNSCards(1, "Build Idea", 1, "Villager", 2, "Wood", 1, "Iron", 1, "Steel", 2, "String")
  ...
  async thereShouldBeNStacksOfNSNSNSCards(expected, n2, s1, n3, s2, n4, s3) {
    ...
    // code: await this.thereShouldBeNStacksOfNSNSNSCards(1, 1, "Build Idea", 1, "Villager", 1, "Arakh")
