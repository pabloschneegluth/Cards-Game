...
export class Post_20221114_Chicken_Context {
  async beforeTest() {
    // Do your setup here
  ...
  async theSMayCreateASCard(ideaName, cardName) {
    ...
    // code: await this.theSMayCreateASCard("Woods Stroll Idea", "Chicken")
  ...
  async givenThatTheOddsAreThatWeWillGetASFromTheSCard(s1, s2) {
    ...
    // code: await this.givenThatTheOddsAreThatWeWillGetASFromTheSCard("Chicken", "Woods Stroll Idea")
  ...
  async thereShouldBeNStacksOfNSNSAndNSCards(
    ...
    // code: await this.thereShouldBeNStacksOfNSNSAndNSCards(1, 1, "Woods Stroll Idea", 1, "Villager", 1, "Chicken")
