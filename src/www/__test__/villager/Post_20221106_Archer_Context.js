...
export class Post_20221106_Archer_Context {
  async beforeTest() {
    // Do your setup here
  ...
  async givenANewGameWithAStackOfNSNSCards(n1, s1, n2, s2) {
    ...
    // code: await this.givenANewGameWithAStackOfNSNSCards(1, "Villager", 1, "Bow")
  ...
  async thereShouldBeNStacksOfNSCards(expected, n2, s1) {
    ...
    // code: await this.thereShouldBeNStacksOfNSCards(1, 1, "Archer")
