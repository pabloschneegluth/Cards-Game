...
@Component
public class Post_20221122_Arrow_Context {
    ...
    Post_20221122_Arrow_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenIdeaService givenIdeaService, GivenStackService givenStackService) {
    ...
    public void givenANewGameWithAStackOfNSNSCardsNSCardsAndNSCards(int n1, String s1, int n2, String s2, int n3, String s3, int n4, String s4) {
        // text:  * Given a new game with a stack of 1 "Build Idea", 1 "Villager" cards, 1 "Stone" cards and 1 "Wood" cards.
        // code: this.givenANewGameWithAStackOfNSNSCardsNSCardsAndNSCards(1, "Build Idea", 1, "Villager", 1, "Stone", 1, "Wood")
    ...
    public void thereShouldBeNStacksOfNSNSAndNSCards(int expected, int n2, String s1, int n3, String s2, int n4, String s3) {
        ...
        // code: this.thereShouldBeNStacksOfNSNSAndNSCards(1, 1, "Build Idea", 1, "Villager", 1, "Arrow")
