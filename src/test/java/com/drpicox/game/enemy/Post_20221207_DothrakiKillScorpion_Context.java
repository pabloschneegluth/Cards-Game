...
@Component
public class Post_20221207_DothrakiKillScorpion_Context {
    ...
    Post_20221207_DothrakiKillScorpion_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenStackService givenStackService) {
    ...
    public void givenThereAreNSCards(int n1, String s1) {
        ...
        // code: this.givenThereAreNSCards(1, "Dothraki")
    ...
    public void thereShouldBeNSCards(int expected, String s1) {
        ...
        // code: this.thereShouldBeNSCards(0, "Scorpion")
