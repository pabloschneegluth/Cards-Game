...
@Component
public class Post_20221127_MilitiaKillZombie_Context {
    ...
    Post_20221127_MilitiaKillZombie_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService) {
    ...
    public void givenThereAreNSCards(int count, String cardName) {
        ...
        // hint: Post_20221117_MilitiaKillCreeper_Context.givenThereAreNSCards
