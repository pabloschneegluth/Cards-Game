...
@Component
public class Post_20221129_DwarfKillTrasgo_Context {
    ...
    Post_20221129_DwarfKillTrasgo_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenStackService givenStackService) {
    ...
    public void givenThereAreNSCards(int n1, String s1) {
        ...
        // hint: Post_20221207_DothrakiKillScorpion_Context.givenThereAreNSCards
    ...
    public void thereShouldBeNSCards(int expected, String s1) {
        ...
        // code: this.thereShouldBeNSCards(0, "Trasgo")
        // hint: Post_20221207_DothrakiKillScorpion_Context.thereShouldBeNSCards
