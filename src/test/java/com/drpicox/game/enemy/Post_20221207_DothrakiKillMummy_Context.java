...
@Component
public class Post_20221207_DothrakiKillMummy_Context {
    ...
    Post_20221207_DothrakiKillMummy_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenStackService givenStackService) {
    ...
    public void thereShouldBeNSCards(int expected, String s1) {
        ...
        // code: this.thereShouldBeNSCards(0, "Mummy")
