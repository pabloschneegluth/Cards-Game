...
@Component
public class Post_20221129_Mummy_Context {
    ...
    Post_20221129_Mummy_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenIdeaService givenIdeaService, GivenStackService givenStackService) {
    ...
    public void givenThereIsTheSIdeaAtLevelNAndNXp(String ideaName, int level, int xp) {
        ...
        // code: this.givenThereIsTheSIdeaAtLevelNAndNXp("Dessert Stroll Idea", 3, 0)
    ...
    public void theSMayCreateASCard(String ideaName, String cardName) {
        ...
        // code: this.theSMayCreateASCard("Dessert Stroll Idea", "Mummy")
    ...
    public void thereShouldBeNStacksOfNSNSNSAndNSCards(int expected, int n2, String s1, int n3, String s2, int n4, String s3, int n5, String s4) {
        ...
        // code: this.thereShouldBeNStacksOfNSNSNSAndNSCards(1, 1, "Dessert Stroll Idea", 1, "Dessert", 1, "Villager", 1, "Mummy")
