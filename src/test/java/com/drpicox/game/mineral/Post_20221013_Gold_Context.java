...
@Component
public class Post_20221013_Gold_Context {
    ...
    Post_20221013_Gold_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenIdeaService givenIdeaService, GivenStackService givenStackService, RandomPickerServiceMock randomPickerServiceMock) {
    ...
    public void theSMayCreateASCard(String ideaName, String cardName) {
        ...
        // code: this.theSMayCreateASCard("Woods Stroll Idea", "Gold")
    ...
    public void givenThatTheOddsAreThatWeWillGetASFromTheSCard(String cardName, String ideaName) {
        ...
        // code: this.givenThatTheOddsAreThatWeWillGetASFromTheSCard("Gold", "Woods Stroll Idea")
    ...
    public void thereShouldBeNStacksOfNSNSAndNSCards(int expected, int count1, String name1, int count2, String name2, int count3, String name3) {
        ...
        // code: this.thereShouldBeNStacksOfNSNSAndNSCards(1, 1, "Woods Stroll Idea", 1, "Villager", 1, "Gold")
