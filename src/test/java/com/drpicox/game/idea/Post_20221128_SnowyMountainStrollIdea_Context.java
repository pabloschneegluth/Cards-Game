...
@Component
public class Post_20221128_SnowyMountainStrollIdea_Context {
    ...
    Post_20221128_SnowyMountainStrollIdea_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenStackService givenStackService) {
    ...
    public void givenANewGameWithAStackOfNSCardsAndNSCard(int n1, String s1, int n2, String s2) {
        ...
        // code: this.givenANewGameWithAStackOfNSCardsAndNSCard(1, "Snowy Mountain", 1, "Villager")
        // hint: Post_20221124_SawmillStrollIdea_Context.givenANewGameWithAStackOfNSCardsAndNSCard

        // Add here what is given
        givenCardService.givenCards(1, "Snowy Mountain");
    ...
    public void thereShouldBeTheSIdea(String expected) {
        ...
        // code: this.thereShouldBeTheSIdea("Snowy Mountain Stroll Idea")
    ...
    public void theSShouldHaveLevelNAndNXp(String ideaName, int level, int xp) {
        ...
        // code: this.theSShouldHaveLevelNAndNXp("Snowy Mountain Stroll Idea", 1, 0)
