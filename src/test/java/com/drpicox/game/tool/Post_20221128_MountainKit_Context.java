...
@Component
public class Post_20221128_MountainKit_Context {
    ...
    Post_20221128_MountainKit_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenIdeaService givenIdeaService, GivenStackService givenStackService) {
    ...
    public void givenANewGameWithAStackOfNSNSNSAndNS(int n1, String s1, int n2, String s2, int n3, String s3, int n4, String s4) {
        // text:  * Given a new game with a stack of 1 "Build Idea", 1 "Villager", 1 "String" and 1 "Leather".
        // code: this.givenANewGameWithAStackOfNSNSNSAndNS(1, "Build Idea", 1, "Villager", 1, "String", 1, "Leather")
    ...
    public void endTheCurrentMoon() {
        ...
        // hint: Post_20221106_Lake_Context.endTheCurrentMoon
    ...
    public void thereShouldBeNStacksOfNSNSAndNSCards(int expected, int n2, String s1, int n3, String s2, int n4, String s3) {
        ...
        // code: this.thereShouldBeNStacksOfNSNSAndNSCards(1, 1, "Build Idea", 1, "Villager", 1, "Mountain Kit")
