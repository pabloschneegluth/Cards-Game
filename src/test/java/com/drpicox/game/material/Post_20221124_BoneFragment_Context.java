...
@Component
public class Post_20221124_BoneFragment_Context {
    ...
    Post_20221124_BoneFragment_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenStackService givenStackService, GivenIdeaService givenIdeaService) {
    ...
    public void givenANewGameWithAStackOfNSNSAndNSCards(int n1, String s1, int n2, String s2, int n3, String s3) {
        ...
        // code: this.givenANewGameWithAStackOfNSNSAndNSCards(1, "Build Idea", 1, "Villager", 3, "Bone Fragment")
    ...
    public void thereShouldBeNStacksOfNSNSAndNSCards(int expected, int n2, String s1, int n3, String s2, int n4, String s3) {
        ...
        // code: this.thereShouldBeNStacksOfNSNSAndNSCards(1, 1, "Build Idea", 1, "Villager", 1, "Bone")
