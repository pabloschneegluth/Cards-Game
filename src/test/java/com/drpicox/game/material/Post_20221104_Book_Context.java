...
public class Post_20221104_Book_Context {
    ...
    Post_20221104_Book_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenStackService givenStackService, GivenIdeaService givenIdeaService) {
    ...
    public void givenANewGameWithAStackOfNSCardsNSAndNSCards(int n1, String s1, int n2, String s2, int n3, String s3) {
        ...
        givenIdeaService.givenIdea(s2);
        givenStackService.givenStacks(1, Names.byNames(n2, s2).and(n3, s3).and(n1, s1));
