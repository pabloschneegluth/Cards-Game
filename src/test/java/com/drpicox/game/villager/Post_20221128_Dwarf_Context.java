...
@Component
public class Post_20221128_Dwarf_Context {
    ...
    Post_20221128_Dwarf_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenStackService givenStackService) {
    ...
    public void givenANewGameWithAStackOfNSNSCards(int n1, String s1, int n2, String s2) {
        ...
        // code: this.givenANewGameWithAStackOfNSNSCards(1, "Villager", 1, "Axe")
    ...
    public void thereShouldBeNStacksOfNSCards(int expected, int n2, String s1) {
        ...
        // code: this.thereShouldBeNStacksOfNSCards(1, 1, "Dwarf")
