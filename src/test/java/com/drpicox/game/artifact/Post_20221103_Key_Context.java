...
@Component
public class Post_20221103_Key_Context {
    ...
    Post_20221103_Key_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService, GivenStackService givenStackService, GivenIdeaService givenIdeaService, RandomPickerServiceMock randomPickerServiceMock, StackService stackService) {
    ...
    public void theSMayCreateASCard(String s1, String s2) {
        ...
        // code: this.theSMayCreateASCard("Woods Stroll Idea", "Key")
    ...
    public void givenThatTheOddsAreThatWeWillGetASCardFromTheSCard(String s1, String s2) {
        ...
        // code: this.givenThatTheOddsAreThatWeWillGetASCardFromTheSCard("Key", "Woods Stroll Idea")
    ...
    public void thereShouldBeNStacksOfNSNSAndNSCards(int expected, int n2, String s1, int n3, String s2, int n4, String s3) {
        ...
        // code: this.thereShouldBeNStacksOfNSNSAndNSCards(1, 1, "Woods Stroll Idea", 1, "Villager", 1, "Key")
