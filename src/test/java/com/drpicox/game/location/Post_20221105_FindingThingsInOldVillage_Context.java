...
@Component
public class Post_20221105_FindingThingsInOldVillage_Context {
    ...
    Post_20221105_FindingThingsInOldVillage_Context(FrontendSimulator frontendSimulator,
    ...
    public void thereShouldBeNStacksOfNSNSNSAndNSCards(int expected, int count1, String name1, int count2, String name2,
        ...
        // code: this.thereShouldBeNStacksOfNSNSNSAndNSCards(1, 1, "Old Village", 1, "Old Village Stroll Idea", 1, "Villager", 1, "Berry")
