...
@Component
public class Post_20221020_WolfCallsWolf_Context {
    ...
    Post_20221020_WolfCallsWolf_Context(FrontendSimulator frontendSimulator, GivenGameService givenGameService, GivenCardService givenCardService) {
    ...
    public void thereShouldBeNSCards(int expected, String cardName) {
        ...
        // code: this.thereShouldBeNSCards(2, "Wolf")
