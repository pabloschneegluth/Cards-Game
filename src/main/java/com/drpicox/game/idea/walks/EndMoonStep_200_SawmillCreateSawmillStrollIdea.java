...
@Component
public class EndMoonStep_200_SawmillCreateSawmillStrollIdea implements EndMoonStep {
    ...
    public EndMoonStep_200_SawmillCreateSawmillStrollIdea(CardFactory cardFactory,
    ...
    public void execute(EndMoonSettings settings) {
        ...
        for (var cards : stack) {
            ...
            var sawmill = location.stream().filter( x -> x.getName().equals("Sawmill")).findFirst();
            if(sawmill.isEmpty()==false){
