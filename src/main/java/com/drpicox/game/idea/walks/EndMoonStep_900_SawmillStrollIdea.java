...
@Component
public class EndMoonStep_900_SawmillStrollIdea implements EndMoonStep {

    public static final String IDEA_NAME = "Sawmill Stroll Idea";
    ...
    public EndMoonStep_900_SawmillStrollIdea(CardFactory cardFactory, IdeaEndMoonStepExecutor ideaEndMoonStepExecutor, IdeaProgressService ideaProgressService, RandomPickerService randomPickerService, CardService cardService) {
    ...
    private void executeIdea(IdeaEndMoonSettings settings) {
        ...
        var sawmills =  cardService.findAllByName("Sawmill");
