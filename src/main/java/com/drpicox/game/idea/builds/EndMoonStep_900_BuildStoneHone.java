...
@Component
public class EndMoonStep_900_BuildStoneHone implements EndMoonStep {
    ...
    public EndMoonStep_900_BuildStoneHone(CardFactory cardFactory,  StackService stackService, CardService cardService, IdeaEndMoonStepExecutor ideaEndMoonStepExecutor) {
    ...
    public void execute(EndMoonSettings settings) {
        ideaEndMoonStepExecutor.execute(settings, IDEA_NAME, this::createStoneHouse);
    }
    ...
    private void createStoneHouse(IdeaEndMoonSettings settings) {
        ...
        List<String> stack = Arrays.asList("build idea", "villager", "stone", "stone", "stone", "stone");
