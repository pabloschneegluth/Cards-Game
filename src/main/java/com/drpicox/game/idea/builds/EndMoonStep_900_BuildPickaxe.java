...
@Component
public class EndMoonStep_900_BuildPickaxe implements EndMoonStep {
    ...
    public EndMoonStep_900_BuildPickaxe(CardFactory cardFactory,  StackService stackService, CardService cardService, IdeaEndMoonStepExecutor ideaEndMoonStepExecutor) {
    ...
    public void execute(EndMoonSettings settings) {
        ideaEndMoonStepExecutor.execute(settings, IDEA_NAME, this::createPickAxe);
    }
    ...
    private void createPickAxe(IdeaEndMoonSettings settings) {
        ...
        List<String> stack = Arrays.asList("build idea", "villager", "wood", "wood", "iron", "iron", "iron");
