...
@Component
public class EndMoonStep_900_BuildPaper implements EndMoonStep {
    ...
    public EndMoonStep_900_BuildPaper(CardFactory cardFactory,  StackService stackService, CardService cardService, IdeaEndMoonStepExecutor ideaEndMoonStepExecutor) {
    ...
    public void execute(EndMoonSettings settings) {
        ideaEndMoonStepExecutor.execute(settings, IDEA_NAME, this::createPaper);
    }
    ...
    private void createPaper(IdeaEndMoonSettings settings) {
        ...
        List<String> stack = Arrays.asList("build idea", "villager", "wood", "wood");
