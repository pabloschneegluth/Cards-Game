...
@Component
public class EndMoonStep_900_BuildBook implements EndMoonStep {
    ...
    public EndMoonStep_900_BuildBook(CardFactory cardFactory,  StackService stackService, CardService cardService, IdeaEndMoonStepExecutor ideaEndMoonStepExecutor) {
    ...
    public void execute(EndMoonSettings settings) {
        ideaEndMoonStepExecutor.execute(settings, IDEA_NAME, this::createBook);
    }
    ...
    private void createBook(IdeaEndMoonSettings settings) {
        ...
        List<String> stack = Arrays.asList("build idea", "villager", "paper", "paper", "paper", "paper", "paper");
