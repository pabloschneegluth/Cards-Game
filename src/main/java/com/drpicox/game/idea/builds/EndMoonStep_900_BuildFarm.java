...
@Component
public class EndMoonStep_900_BuildFarm implements EndMoonStep {
    ...
    public EndMoonStep_900_BuildFarm(CardFactory cardFactory,  StackService stackService, CardService cardService, IdeaEndMoonStepExecutor ideaEndMoonStepExecutor) {
    ...
    public void execute(EndMoonSettings settings) {
        ideaEndMoonStepExecutor.execute(settings, IDEA_NAME, this::createFarm);
    }
    ...
    private void createFarm(IdeaEndMoonSettings settings) {
        ...
        List<String> stack = Arrays.asList("build idea", "villager", "stone", "wood", "wood");
